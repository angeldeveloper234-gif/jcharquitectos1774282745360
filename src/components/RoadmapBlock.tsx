    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col gap-2">
                <span className="text-xs font-mono text-primary font-black tracking-widest">PHASE {step}</span>
                <h3 className="text-xl font-display text-white uppercase tracking-widest group-hover:translate-x-4 transition-transform duration-500">{title}</h3>
